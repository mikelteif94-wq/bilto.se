...
export default function ElCarCard({
  ...
  return (
    <div
      ...
      style={{
        background: 'linear-gradient(155deg, #0f172a 0%, #0c1a2e 55%, #051020 100%)',
        touchAction: 'pan-y',
      }}
    >
      {/* Top accent line */}
      ...
      <div className="px-3.5 pt-3 pb-1 flex-1 flex flex-col">
        <div className="flex items-start gap-2 mb-2">
          ...
          <div className="flex-1 min-w-0">
            ...
            {expertComment && (
              <p className="hidden sm:block mt-0.5 text-[11px] text-slate-400 leading-snug line-clamp-2">
                {expertComment}
              </p>
            )}
          </div>
        ...
        {rangeKm != null && (
          <div className="mb-2 flex items-center gap-1.5">
            <div className="flex-1 h-1 rounded-full bg-white/10 overflow-hidden">
              <div
                className="h-full rounded-full bg-gradient-to-r from-[#38bdf8] to-[#34d399]"
