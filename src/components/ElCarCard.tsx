...
function fuelLabelToTypes(fuelLabel?: string): string[] {
  ...
  return types.length > 0 ? types : ['el'];
}
      ...
      <div className="hidden sm:block">
        <div className="cursor-pointer" onClick={() => onDetail?.()}>
          ...
          <div className="px-3.5 pt-3 pb-2">
            ...
            {showMeter && <div className="mt-1.5"><OwnershipMeter carPrice={carPrice ?? usedPrice!} usedPrice={usedPrice} fuelTypes={fuelTypes} fuelLabel={fuelLabel} make={name.split(' ')[0]} mode={mode} /></div>}
          </div>
        </div>
