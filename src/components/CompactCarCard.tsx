...
export default function CompactCarCard({
  ...
  return (
    <div
      className={`group relative bg-white rounded-2xl overflow-hidden transition-all duration-300 cursor-pointer ${ringClass}`}
      ...
      <div className="flex sm:hidden" onClick={handleCardClick}>
        ...
        <div className="flex-1 min-w-0 flex flex-col p-3 gap-1">
          ...
          <div className="flex flex-wrap items-center gap-1">
            ...
            {seats != null && seats > 0 && (
              <span className="inline-flex items-center gap-0.5 px-1 py-0.5 rounded text-[8px] font-semibold bg-slate-100 text-slate-500">
