...
export default function ImageUploadForm({ initialImages, onNext }: ImageUploadFormProps) {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      {error && (
        <div role="alert" className="flex items-start gap-2.5 p-3 rounded-xl bg-red-50 border border-red-200 text-red-800 text-[14px] font-medium">
          <XCircle className="w-5 h-5 text-red-500 shrink-0 mt-[1px]" strokeWidth={2.5} />
