  ...
  return (
    <div className="space-y-6">
      ...
      <button
        ...
        className="group relative w-full text-left rounded-2xl border border-[#0e6efe]/30 bg-[#0e6efe]/[0.04] p-5 sm:p-6 hover:border-[#0e6efe] hover:bg-[#0e6efe]/[0.08] transition-all"
      >
        <div className="flex items-start gap-4">
          <div className="w-11 h-11 rounded-full bg-[#0e6efe]/15 flex items-center justify-center shrink-0">
            <Handshake className="w-5 h-5 text-[#0e6efe]" strokeWidth={2.2} />
          </div>
          <div className="flex-1 min-w-0">
            <div className="flex items-center justify-between gap-3">
              <h3 className="text-[17px] sm:text-[18px] font-semibold text-slate-900 tracking-tight">
      ...
      <button
        ...
        className="group relative w-full text-left rounded-2xl border border-emerald-200 bg-emerald-50/60 p-5 sm:p-6 hover:border-emerald-400 hover:bg-emerald-50 transition-all"
      >
        <div className="flex items-start gap-4">
          <div className="w-11 h-11 rounded-full bg-emerald-100 flex items-center justify-center shrink-0">
            <Search className="w-5 h-5 text-emerald-600" strokeWidth={2.2} />
          </div>
          <div className="flex-1 min-w-0">
            <div className="flex items-center justify-between gap-3">
              <h3 className="text-[17px] sm:text-[18px] font-semibold text-slate-900 tracking-tight">
              ...
              <ArrowRight className="w-5 h-5 text-emerald-500 shrink-0 group-hover:translate-x-0.5 transition-transform" />
            </div>
            <p className="text-[14.5px] text-slate-600 leading-[1.55] mt-1.5">
      ...
      <button
        ...
        className="group relative w-full text-left rounded-2xl border border-amber-200 bg-amber-50/60 p-5 sm:p-6 hover:border-amber-400 hover:bg-amber-50 transition-all"
      >
        <div className="flex items-start gap-4">
          <div className="w-11 h-11 rounded-full bg-amber-100 flex items-center justify-center shrink-0">
            <ArrowLeftRight className="w-5 h-5 text-amber-600" strokeWidth={2.2} />
          </div>
          <div className="flex-1 min-w-0">
            <div className="flex items-center justify-between gap-3">
              <h3 className="text-[17px] sm:text-[18px] font-semibold text-slate-900 tracking-tight">
              ...
              <ArrowRight className="w-5 h-5 text-amber-500 shrink-0 group-hover:translate-x-0.5 transition-transform" />
            </div>
            <p className="text-[14.5px] text-slate-600 leading-[1.55] mt-1.5">
      ...
      <div className="pt-2">
        <button
          type="button"
          onClick={onGuidance}
          className="w-full flex items-center justify-center gap-2 text-[14px] text-slate-500 hover:text-[#0e6efe] transition-colors py-2"
        >
