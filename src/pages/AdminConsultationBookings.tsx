              ...
              {filtered.map(b => (
                <div key={b.id} className="p-4 sm:p-5 hover:bg-slate-50/50 transition">
                  <div className="flex flex-col sm:flex-row sm:items-start gap-4">
                    {/* Date/time badge */}
                    <div className="shrink-0 bg-[#0e6efe]/8 rounded-xl px-3 py-2.5 text-center min-w-[90px]">
                      <p className="text-[11px] font-semibold text-[#0e6efe] uppercase tracking-wide">
                        {formatDate(b.booking_date)}
                      </p>
                      <p className="text-lg font-bold text-[#0e6efe] mt-0.5">kl. {b.booking_time}</p>
                    </div>
