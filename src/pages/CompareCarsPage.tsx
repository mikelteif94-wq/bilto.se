...
export default function CompareCarsPage({ onBackHome, pageSlug = 'kop-bil', heroTitle, heroSubtitle, defaultCategory, ctaOptions, defaultFuelTypes }: CompareCarsPageProps) {
  ...
  return (
    <div className="min-h-screen bg-[#faf8f5]">
      {/* Navbar */}
      <header className={`fixed top-3 inset-x-3 lg:top-4 lg:inset-x-20 z-30 h-16 rounded-full shadow-lg ring-1 ring-white/10 transition-colors duration-300 ${scrolled ? 'bg-[#0e6efe]' : 'bg-[#0e6efe]/40 backdrop-blur-md'}`}>
