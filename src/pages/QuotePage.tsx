        ...
        <div className="max-w-6xl mx-auto px-5 sm:px-6 py-8 sm:py-12">
          <div className="grid md:grid-cols-12 gap-8 items-center">
            ...
            <div className="md:col-span-7 order-2">
              <div className="relative rounded-xl overflow-hidden bg-[#0e6efe] h-[300px] sm:h-[460px] md:h-[520px]">
                <img
                  ...
                  className="absolute inset-0 w-full h-full object-cover object-[center_15%] scale-[1.03]"
                />
