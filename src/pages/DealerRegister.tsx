...
export default function DealerRegister({ onBack, mode = 'landing', onNavigateApply }: DealerRegisterProps) {
  ...
  return (
    <div className="min-h-screen bg-[#faf8f5] text-slate-900">
      ...
      />
      <header className={`fixed top-3 inset-x-3 lg:top-4 lg:inset-x-32 z-30 h-14 lg:h-16 rounded-xl shadow-lg ring-1 ring-white/10 transition-colors duration-300 ${showForm || scrolled ? 'bg-[#0e6efe]' : 'bg-[#0e6efe]/40 backdrop-blur-md'}`}>
