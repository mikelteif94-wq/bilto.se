...
export default function SetPasswordPage({ onDone }: SetPasswordPageProps) {
  ...
  if (!hasSession) {
    return (
      <div className="min-h-screen bg-[#faf8f5] flex items-center justify-center px-4">
        <div className="max-w-md w-full bg-[#faf8f5] border border-slate-200 rounded-xl p-8 text-center shadow-sm">
  ...
  if (done) {
    return (
      <div className="min-h-screen bg-[#faf8f5] flex items-center justify-center px-4">
        <div className="max-w-md w-full bg-[#faf8f5] border border-slate-200 rounded-xl p-10 text-center shadow-sm">
  ...
  return (
    <div className="min-h-screen bg-[#faf8f5] flex items-center justify-center px-4 py-12">
      <div className="max-w-md w-full bg-[#faf8f5] border border-slate-200 rounded-xl p-8 shadow-sm">
        <div className="mb-6">
          ...
          <p className="text-slate-600 text-sm">
            Ange ditt lösenord två gånger för att aktivera ditt konto.
          </p>
        </div>
