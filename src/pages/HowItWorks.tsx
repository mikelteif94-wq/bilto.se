...
export default function HowItWorks({ onBackHome, onSell, showSeo = false, pageTitle }: HowItWorksProps) {
  ...
  return (
    <div className="min-h-screen bg-[#faf8f5] text-slate-900">
                ...
                {heroTab === 'salj' ? (
                  ...
                  <div ref={carSearchRef} className="relative space-y-3">
                    <div className="relative">
                      <div className="flex items-center h-12 rounded-xl bg-slate-50 border-2 border-slate-200 overflow-visible focus-within:border-[#0e6efe] focus-within:bg-[#faf8f5] focus-within:shadow-[0_0_0_4px_rgba(14,110,254,0.08)] transition-all duration-200">
                      ...
                      {showSuggestions && carSuggestions.length > 0 && (
                        <div className="absolute left-0 right-0 top-full mt-1.5 bg-[#faf8f5] rounded-xl shadow-[0_8px_32px_-8px_rgba(15,23,42,0.18)] border border-slate-100 overflow-hidden z-50">
                      ...
                      <div className="flex flex-wrap gap-1.5">
                        {[
                          ...
                          <button
                            ...
                            type="button"
                            onClick={() => handleCarSelect(s.make, s.model)}
                            className="inline-flex items-center gap-1 text-[12px] text-slate-600 hover:text-[#0e6efe] bg-[#faf8f5] hover:bg-blue-50 border border-slate-200 hover:border-[#0e6efe]/40 rounded-xl px-3 py-1.5 font-medium transition-all shadow-[0_1px_3px_rgba(0,0,0,0.05)]"
                          >
      ...
      {/* ── Så enkelt är det ──────────────────────────────── */}
      <section id="sa-fungerar-det" className="bg-[#faf8f5] px-4 sm:px-6 py-16 sm:py-24">
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-2 gap-10 lg:gap-16 items-center">
            ...
            <div className="relative rounded-xl overflow-hidden">
              ...
              <div className="hidden sm:block absolute left-6 bottom-6 bg-[#faf8f5] rounded-xl p-4 shadow-lg max-w-xs">
      ...
      {/* ── Populära bilar ────────────────────────────────── */}
      <section id="experternas-val" className="bg-[#faf8f5] px-4 sm:px-6 py-16 sm:py-24">
        <div className="max-w-5xl mx-auto">
          <div className="mb-10 sm:mb-14">
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-2 gap-10 lg:gap-16 items-center">
            ...
            <div className="relative rounded-xl overflow-hidden aspect-square max-w-[480px] mx-auto w-full">
              ...
              <div className="hidden md:block absolute right-5 bottom-5 max-w-[240px] bg-[#faf8f5] rounded-xl p-4 shadow-lg">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid sm:grid-cols-3 gap-px bg-slate-200 rounded-xl overflow-hidden ring-1 ring-slate-200">
            {[
              ...
              const Icon = b.icon;
              return (
                <div key={b.title} className="bg-[#faf8f5] p-7 sm:p-9 flex flex-col">
      ...
      {/* ── CTA-band ──────────────────────────────────────── */}
      <section className="bg-[#faf8f5] px-4 sm:px-6 py-12 sm:py-16">
        <div className="max-w-6xl mx-auto">
          <div className="relative rounded-[24px] sm:rounded-[40px] bg-[#0e6efe] px-6 py-10 sm:px-12 sm:py-12 lg:px-16 lg:py-14 overflow-hidden">
            <div className="absolute -right-20 -top-20 w-[360px] h-[360px] rounded-full bg-[#faf8f5]/5 pointer-events-none" />
            <div className="absolute -left-12 -bottom-16 w-[280px] h-[280px] rounded-full bg-[#faf8f5]/5 pointer-events-none" />
            ...
            <div className="relative grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
              <div>
                ...
                <ul className="mt-6 space-y-3">
                  {[
                    ...
                    <li key={text} className="flex items-center gap-3">
                      <span className="shrink-0 w-5 h-5 rounded-full flex items-center justify-center bg-[#faf8f5]/20">
                ...
                <div className="mt-8 flex flex-col sm:flex-row gap-3">
                  <a
                    href="/gratis-konsultation"
                    className="inline-flex items-center justify-center h-12 px-7 rounded-xl bg-[#faf8f5] text-[#0e6efe] text-[15px] font-bold transition-all hover:bg-slate-100 active:scale-[0.98] shadow-[0_8px_24px_-8px_rgba(0,0,0,0.25)]"
                  >
                    Kostnadsfri konsultation
                  </a>
                  <a
                    href="tel:+46855550200"
                    className="inline-flex items-center justify-center h-12 px-7 rounded-xl border-2 border-white/40 text-white text-[15px] font-semibold transition-all hover:bg-[#faf8f5]/10 active:scale-[0.98]"
                  >
              ...
              <div className="relative h-[260px] sm:h-[320px] lg:h-[360px]">
                ...
                <div className="absolute bottom-0 right-0 bg-[#faf8f5] rounded-xl shadow-xl p-2.5 w-[148px] sm:w-[168px]">
      ...
      {carsModalOpen && (
        ...
        >
          <div
            className="relative w-full max-w-2xl max-h-[90vh] overflow-y-auto bg-[#faf8f5] rounded-xl shadow-2xl"
