...
export default function HowItWorks({ onBackHome, onSell, showSeo = false, pageTitle }: HowItWorksProps) {
  ...
  return (
    <div className="min-h-screen bg-white text-slate-900">
      ...
      />
      <header className={`fixed top-3 inset-x-3 lg:top-4 lg:inset-x-32 z-40 h-14 lg:h-16 rounded-xl shadow-lg ring-1 ring-white/10 transition-colors duration-300 bg-[#0e6efe] ${!scrolled ? 'backdrop-blur-md' : ''}`}>
