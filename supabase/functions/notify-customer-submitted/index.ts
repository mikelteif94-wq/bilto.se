  ...
  return emailShell({
    ...
    bodyContent: `
      ...
      <div style="margin-top:28px;">
        <a href="${escAttr(d.trackingUrl)}" style="display:inline-block;background:#0e6efe;color:#ffffff;text-decoration:none;padding:15px 32px;border-radius:10px;font-weight:700;font-size:15px;letter-spacing:0.02em;">Följ din bil &rarr;</a>
      </div>` : ""}
    `,
  });
}
      ...
      <table width="100%" cellpadding="0" cellspacing="0" style="max-width:580px;">
        ...
        <tr><td align="center" style="padding-bottom:24px;">
          <a href="${escAttr(opts.site)}" style="text-decoration:none;">
            <img src="${escAttr(LOGO_URL)}" alt="Bilto" width="120" style="width:120px;height:auto;display:block;" />
          </a>
        </td></tr>
