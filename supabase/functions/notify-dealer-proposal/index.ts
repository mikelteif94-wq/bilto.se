    ...
    <tr><td align="center">
      <table width="100%" cellpadding="0" cellspacing="0" style="max-width:580px;">
        ...
        <tr><td align="center" style="padding-bottom:24px;">
          <a href="${SITE}" style="text-decoration:none;display:inline-block;background:#0e6efe;border-radius:12px;padding:12px 28px;"><img src="${LOGO_URL}" alt="Bilto" width="110" style="width:110px;height:auto;display:block;"/></a>
        </td></tr>
