    ...
    <table width="100%" cellpadding="0" cellspacing="0" style="max-width:600px;margin:0 auto;background:#ffffff;border:1px solid #e2e8f0;border-radius:16px;overflow:hidden;">
      <tr>
        <td style="padding:0;line-height:0;">
          <a href="https://bilto.se" style="text-decoration:none;display:block;">
            <img src="${LOGO_URL}" alt="Bilto" width="600" style="width:100%;max-width:600px;height:auto;display:block;border-radius:16px 16px 0 0;" />
          </a>
        </td>
      </tr>
      <tr>
